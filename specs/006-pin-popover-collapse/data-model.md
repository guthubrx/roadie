...
| `button_size` | Double | `14` | Diamètre approximatif style bouton macOS |
| `button_color` | String | `#0A84FF` | Couleur du bouton |
| `titlebar_height` | Double | `36` | Bande haute de placement probable |
| `leading_exclusion` | Double | `84` | Zone gauche réservée aux boutons natifs |
...
| `reason` | String | `eligible`, `disabled`, `not_pinned`, `too_small`, `unsafe_titlebar`, `fullscreen`, `transient` |
...
- Une fenêtre non pinée n'a pas de contrôle visible permanent.
