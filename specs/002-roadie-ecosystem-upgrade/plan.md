...
**Branch**: `002-roadie-ecosystem-upgrade` | **Date**: 2026-05-08 | **Spec**: [spec.md](./spec.md)
...
**Testing**: Swift Testing dans `Tests/`, tests d'acceptation documentés par scénario SpecKit 002  
...
5. **Hardening** : migration de fichiers existants, documentation utilisateur, tests d'acceptation multi-display simulés.
