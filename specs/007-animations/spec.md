...
**Created**: 2026-05-01
**Status**: Implemented (engine Bézier + queue + factory + router + module + OSAXCommand.setFrame + Animation.toCommand .frame + mode crossfade entrant via EventContext.incomingWIDs + window_resized frame interpolation livrés 2026-05-01 ; integration stress test runtime à valider sur machine SIP partial off)
